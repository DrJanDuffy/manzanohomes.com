...
export async function GET() {
  return json({
    environment: {
      FOLLOW_UP_BOSS_API_KEY: process.env.FOLLOW_UP_BOSS_API_KEY ? 'Set (length: ' + process.env.FOLLOW_UP_BOSS_API_KEY.length + ')' : 'Missing',
      ...
      SMS_AUTO_REPLY_MESSAGE: process.env.SMS_AUTO_REPLY_MESSAGE ? 'Set (length: ' + process.env.SMS_AUTO_REPLY_MESSAGE.length + ')' : 'Missing'
    },
