...
<div id="main-content" class="min-h-screen bg-gray-50">
  ...
  <section class="bg-gradient-primary text-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20 max-w-2xl">
        ...
        <h3 class="text-lg font-semibold text-white mb-2">Complete Home Buying Guide</h3>
        <p class="text-primary-100 mb-4 text-sm">Comprehensive market insights and expert guidance for first-time and experienced buyers</p>
        <a 
